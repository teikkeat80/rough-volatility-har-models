...
# Load Data
path = 'C:\\Users\\teikkeattee\\ProjProg\\SNP500_RV_5min.csv'
df = pd.read_csv(path).sort_values(by='Date', ignore_index=True)
rv = df['RV'].tolist()
log_rv = np.log(rv)
...
print('AIC: ', aic)
with open(f'C:\\Users\\teikkeattee\\ProjProg\\HARK2_RV_EST.pickle', 'wb') as file:
